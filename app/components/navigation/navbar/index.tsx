...
const Navbar = ({ toggle }: { toggle: () => void }) => {
  ...
  return (
    <div className={`w-full h-20 2xl:h-28 bg-white sticky z-10 block ${ scrollDirection === "hide" ? "-top-20 2xl:-top-28 opacity-20" : "top-0 opacity-100"} transition-all duration-500`}>
