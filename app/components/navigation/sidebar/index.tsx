...
const Sidebar = ({
  ...
  return (
    <>
      <div
        className="bg-gradient-to-r from-indigo-100 to-indigo-200 sidebar-container fixed w-full h-full overflow-hidden justify-center grid pt-[120px] left-0 z-10"
        style={{
          opacity: `${isOpen ? "1" : "0"}`,
          top: ` ${isOpen ? "0" : "-100%"}`,
        }}
