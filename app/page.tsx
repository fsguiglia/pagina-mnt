  ...
  return (
    <main className="pl-12 pt-12">
      <div className="h-screen md:snap-y md:snap-mandatory overflow-scroll">
        ...
        <div className="grid grid-cols-1 pr-8 md:grid-cols-2 md:min-h-[calc(100vh-20px)] content-start scroll-mt-40 mb-10 md:snap-always md:snap-end" id="portada">
        ...
        <div className="grid grid-cols-1 pr-8 md:grid-cols-2 md:min-h-[calc(100vh-20px)] mb-20 md:snap-always md:snap-end">
        ...
        <div className="md:min-h-[calc(100vh-20px)] pr-8 scroll-mt-40 mb-20 md:snap-always md:snap-end" id="descargas">
        <div>
              <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                Descargas
              </h1>
        ...
        <div className="md:min-h-[calc(100vh-20px)] pr-8 scroll-mt-40 mb-20 md:snap-always md:snap-end" id="tutoriales">
        <div>
            ...
            <div className="md:text-2xl text-2xl">
              ...
              <p className="pb-5">
                <Link href="https://www.youtube.com/playlist?list=PLEMVlXTcC5rn0nzcSsK7CfwKhJ1gFrZIB" target="_blank">Videos en youtube</Link>
              </p>
            </div>
        </div>

        <div className="md:min-h-[calc(100vh-20px)] pr-8 scroll-mt-40 mb-20 md:snap-always md:snap-end" id="contacto">
        <div>
              <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white pb-4">
                Contacto
              </h1>
        ...
        <div className="md:h-[calc(100vh)] pr-8 scroll-mt-40 md:snap-always md:snap-end" id="publicaciones">
        <div>
              <h1 className="mb-20 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white pb-4">
                Publicaciones
              </h1>
            </div>
            <div>
